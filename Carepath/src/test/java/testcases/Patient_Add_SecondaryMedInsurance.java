...
public class Patient_Add_SecondaryMedInsurance extends TestBase {
	...
	public void patient_add_secMedInsurance(Hashtable<String,String> data) throws InterruptedException, IOException{
		
		 if(!(TestUtil.isRunnable("Patient_Add_SecondaryMedInsurance", excel))){
				
				throw new SkipException("Skipping the test "+"Patient_Add_SecondaryMedInsurance" + "as the Run mode is set as NO");
			}
...
public Object[][] getData() {
	...
	return TestUtil.getPatientData("AddSecMedInsurance");
