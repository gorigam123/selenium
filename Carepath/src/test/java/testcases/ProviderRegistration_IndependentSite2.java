...
public class ProviderRegistration_IndependentSite2 extends TestBase{
	...
	Thread.sleep(8000);
	  ...
	  if(config.getProperty("environment").equals("SIT2"))
	  {
		  ...
		  {		  
			  type("ProviderRegIndSite_Username_XPATH",providermailid);
			  Thread.sleep(4000);
			  type("ProviderRegIndSite_confirmUsername_XPATH",providermailid);
			  Thread.sleep(3000);
			  ...
			  type("ProviderRegIndSite_confirmPasword_XPATH",data.get("password"));
				  ...
				  type("ProviderRegIndSite_Username_XPATH",mailinatorid);
				  Thread.sleep(4000);
				  type("ProviderRegIndSite_confirmUsername_XPATH",mailinatorid);
				  Thread.sleep(3000);
				  type("ProviderRegIndSite_Pasword_XPATH",data.get("password"));  
				  Thread.sleep(4000);
				  type("ProviderRegIndSite_confirmPasword_XPATH",data.get("password"));
	  ...
	  if(config.getProperty("environment").equals("DevDox"))
	  {
		  ...
		  {		  
			...
			//type("confirmReenterpwd_XPATH",data.get("password"));
				...
				type("confirmUsername_XPATH",mailinatorid);
				type("confirmPasword_XPATH",data.get("password"));
				type("confirmReenterpwd_XPATH",data.get("password"));
				//driver.findElement(By.xpath(OR.getProperty("confirmReenterpwd_XPATH"))).clear();
				//type("confirmReenterpwd_XPATH",data.get("password"));
